...
$env:PYTHONPATH='src'; python -m news_platform.main --public-records-smoke --public-sources cwa_earthquake_report
...
$env:PYTHONPATH='src'; python -m news_platform.main --collect-public-records --public-sources cwa_earthquake_report
