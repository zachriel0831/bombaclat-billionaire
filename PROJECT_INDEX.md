...
| CWA fixed visible schedule | `powershell -ExecutionPolicy Bypass -File .\scripts\register_cwa_fixed_window_task.ps1 -StartNow` |
| CWA typhoon/earthquake records | `powershell -ExecutionPolicy Bypass -File .\scripts\run_cwa_weather.ps1 -EnvFile .env` |
| CWA earthquake high-frequency records | `powershell -ExecutionPolicy Bypass -File .\scripts\run_cwa_earthquake.ps1 -EnvFile .env` |
