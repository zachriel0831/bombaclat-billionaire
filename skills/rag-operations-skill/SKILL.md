...
description: Maintain, debug, or extend historical-case RAG in data-collecting. Use when working on event_relay.rag, t_event_embeddings, t_analysis_embeddings, run_rag_indexer.ps1, RAG telemetry in t_market_analyses.raw_json, Codex historical analogues, or RAG failure handling.
---
...
Use this skill for historical-case RAG work used by Codex market analysis.
...
3. Read [../../memory-bank/09-decisions/2026-05-07-hybrid-rag-stage0-claim-router.md](../../memory-bank/09-decisions/2026-05-07-hybrid-rag-stage0-claim-router.md) only for historical context.
4. Inspect `src/event_relay/rag.py` for implementation details.
...
- RAG failure must degrade to zero examples and record telemetry; it must not block analysis storage.
